...
const createContact = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const adminEmail = process.env.ADMIN_EMAIL || "dushimiyimanaelisa@gmail.com";
        if (adminEmail) {
            yield (0, sendEmails_1.default)(adminEmail, "New Contact Message Received", `<h3>New Contact Message</h3>
